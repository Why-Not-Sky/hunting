...
insert into indicator_definition(idc_id, idc_name, idc_type, period, cycle) values (11, 'rsv:日', 'rsv', 9, 'd');
insert into indicator_definition(idc_id, idc_name, idc_type, period, cycle) values (12, 'rsv:周', 'rsv', 9, 'w');
