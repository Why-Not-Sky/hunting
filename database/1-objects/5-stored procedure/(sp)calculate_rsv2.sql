...
*********************************************************************************************/
--DROP FUNCTION calculate_rsv2(from_date date, to_date date, n int, idc int) 
------------------------------------------------------------------------------------------------------
CREATE OR REPLACE FUNCTION calculate_rsv2(begin_date date, end_date date, n int, idc int) 
    RETURNS void AS $$
